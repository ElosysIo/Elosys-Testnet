...
impl ProposedTransaction {
    ...
    /// as the miners fee.
    pub fn post_miners_fee(&mut self) -> Result<Transaction, ElosysError> {
    ...
    pub fn post_miners_fee_unchecked(&mut self) -> Result<Transaction, ElosysError> {
    ...
    fn _partial_post(&self) -> Result<Transaction, ElosysError> {
